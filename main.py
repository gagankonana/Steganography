...
def text_steno():
    ...
    def encode():
        ...
        def execute():
            ...
            global outfile_loc, m_or_f,infile_loc
...
lb = Label(root, text="steganography\n- IAS MINI PROJECT", font=('Showcard Gothic', 20), bg='#f5f59a', fg='#8507fa')
lb.place(x=18, y=20)
...
#audio = Button(root, text='Audio\nsteganography', relief='flat', bg='#A68064', command=print("work in progress"), font=cas)
